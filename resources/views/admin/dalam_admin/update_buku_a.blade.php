...
@section('content')
    <div class="container-fluid px-4">
                        ...
                        <form action="{{ route('buku.update', ['buku_id' => $bukus->buku_id]) }}" enctype="multipart/form-data" class="row my-4 gap-3" method="post">
                            @csrf
                            @method('PATCH')
                            <div class="row gap-3">
                                <div class="col-12 col-md-4 form-group">
                                    <label for="judul_buku" class="form-label" >Judul Buku *</label>
                                    <input type="text" name="judul_buku" id="judul_buku" class="form-control" placeholder="Masukkan judul buku" value="{{$bukus ->buku_judul}}">
                                </div>
                                <div class="col-12 col-md-4 form-group">
                                ...
                                <div class="col-12 col-md-4 form-group">
                                    ...
                                    <input type="text" name="tahun_terbit" id="tahun_terbit" class="form-control" placeholder="Masukkan tahun terbit" value="{{$bukus->buku_thnpenerbit}}">
                                </div>
                                <div class="col-12 col-md-4 form-group">
                                ...
                                <div class="col-12 col-md-4 form-group">
                                    ...
                                    <input type="text" name="isbn" id="isbn" class="form-control" placeholder="Masukkan nomor ISBN" value="{{$bukus->buku_isbn}}">
                                </div>
                                <div class="col-12 col-md-4 form-group">
                                    <label for="isbn" class="form-label" > Gambar Buku *</label>
                                    <input type="file" name="buku_gmbr" id="isbn" class="form-control" placeholder="Masukkan nomor ISBN" value="{{$bukus->buku_isbn}}">
                                </div>
                            </div>
                            <div class="row my-3">
